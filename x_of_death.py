...
#see the version
    ...
    input("The current version you are useing for x of death is 1.0.0 [press enter to continue also close and reopen the language if you are entering another command]")
    code_user = input("")
